  ...
  describe('fields manipulation', () => {
    ...
    describe('removeField()', () => {
      ...
      it('should remove field via dot-notation', () => {
        ...
        `);
        sc.getOTC('Type').removeField(['field1.subField1.subSubField1', 'field1.subField1.nonexistent', 'field1.nonexistent.nonexistent', 'field1.subField3', 'field2', '', '..']);
        expect(sc.getOTC('Type').toSDL({
          deep: true,
    ...
    it('makeFieldNullable()', () => {
      tc.setField('fieldNN', 'String!');
      expect(tc.getFieldType('fieldNN')).toBeInstanceOf(GraphQLNonNull);
      expect(tc.getFieldType('fieldNN').ofType).toBe(GraphQLString); // should unwrap GraphQLNonNull
