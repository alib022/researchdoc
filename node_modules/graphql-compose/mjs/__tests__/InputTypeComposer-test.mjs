...
describe('InputTypeComposer', () => {
  ...
  describe('field manipulation methods', () => {
    ...
    describe('removeField()', () => {
      ...
      it('should remove field via dot-notation', () => {
        ...
        `);
        schemaComposer.getITC('Type').removeField(['field1.subField1.subSubField1', 'field1.subField1.nonexistent', 'field1.nonexistent.nonexistent', 'field1.subField3', 'field2', '', '..']);
        expect(schemaComposer.getITC('Type').toSDL({
          deep: true,
  ...
  describe('static method create()', () => {
    ...
    it('should create ITC by ComposeObjectTypeConfig with unexisted types', () => {
      ...
      expect(itc1.getField('f2').type.ofType).toBeInstanceOf(ThunkComposer);
  ...
  describe('merge()', () => {
    ...
    it('should throw error on wrong type', () => {
      const filterITC = schemaComposer.createInputTC(`input Filter { name: String }`);
      expect(() => filterITC.merge(schemaComposer.createScalarTC('Scalar'))).toThrow('Cannot merge ScalarTypeComposer');
    });
  });
