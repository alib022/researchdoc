...
class InputTypeComposer {
  ...
  setFields(fields) {
    this._gqcFields = this.schemaComposer.typeMapper.convertInputFieldConfigMap(fields, this.getTypeName());
    return this;
  }

  setField(fieldName, fieldConfig) {
    this._gqcFields[fieldName] = this.schemaComposer.typeMapper.convertInputFieldConfig(fieldConfig, fieldName, this.getTypeName());
    return this;
  }
  /**
  ...
  addFields(newFields) {
    this._gqcFields = _objectSpread({}, this._gqcFields, {}, this.schemaComposer.typeMapper.convertInputFieldConfigMap(newFields, this.getTypeName()));
    return this;
  }
  /**
  ...
  getFieldITC(fieldName) {
    ...
    if (!(tc instanceof InputTypeComposer)) {
      throw new Error(`${this.getTypeName()}.getFieldITC('${fieldName}') must be InputTypeComposer, but recieved ${tc.constructor.name}. Maybe you need to use 'getFieldTC()' method which returns any type composer?`);
    }
